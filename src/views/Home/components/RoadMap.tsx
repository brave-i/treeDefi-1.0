    ...
    en: [
      {
        ...
        cardDetailedText: [
          'TechRate Audit Passed - Listed on CoinMarketcap - Listed on DappRadar - Listed on Coingecko - GreenWheel Game - BSC News Article - Youtube Marketing - Meme of the day - Crypto Governance - NFTrees Alpha Release - API DefiStation - UI v 1.5 - AutoCompound - Automatic TPT - New SEED Token Design ',
        ],
      },
      {
        title: 'IN PROGRESS',
        ...
        cardDetailedText: [
          'Proprietary AMM - NFTrees Improvements - ESP/CN Communities - AutoCompound - NFTrees Marketplace - IFO',
        ],
      },
      {
        title: 'MEDIUM TERM',
