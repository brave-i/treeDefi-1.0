      ...
      <Page>
        <div>
          ...
          <PartnerCard>
            ...
            >
              <img src="/images/partner/coinmarketcap.png" alt="Coinmarketcap" className="logopartner" />
            </Link>
            <Link
              external
              ...
              style={{ marginRight: 'auto', marginLeft: 'auto', gridColumn: 'span 2' }}
            >
              <img src="/images/partner/coingecko.png" alt="Coingecko" className="logopartner" />
            </Link>
            <Link
              external
              ...
              style={{ marginRight: 'auto', marginLeft: 'auto', gridColumn: 'span 2' }}
            >
              <img src="/images/partner/dappradar.png" alt="Dappradar" className="logopartner" />
            </Link>
            <Link
              external
            ...
            <Link
              ...
              style={{ marginRight: 'auto', marginLeft: 'auto', gridColumn: 'span 2' }}
            >
              <img src="/images/partner/blockfolio.png" alt="Blockfolio" className="logopartner" />
            </Link>{' '}
            {/*
            <Link
              external
          ...
          <YoutubeCard>
            <YoutubeEmbed embedId="1BhL7deSbHg" />
            <YoutubeEmbed embedId="s6XgMenHxHU" />
          </YoutubeCard>
        </div>
      </Page>
      <Footer />
